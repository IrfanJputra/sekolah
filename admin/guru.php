...
?>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control" id="nip" name="jabatan" placeholder="Jabatan" required>
                </div>
                <div class="form-group">
                ...
                <p style="color: red;">  Format Gambar JPG, JPEG, PNG*</p>
                </div>
                </div>
              </div>
     ...
     <div class="modal fade" id="modalEdit<?= $no ?>">
      ...
      <form action="" method="post">
        <input type="hidden" name="id_guru" value="<?= $baris['id_guru']; ?>">
        <div class="modal-body">
