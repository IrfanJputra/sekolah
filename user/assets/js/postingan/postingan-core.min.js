...
function error_b(e = "", a = "", t = "") {
    let r = $(".sidebar.error");
    r.html() ? (r.children("h2").text("Error Report"), r.append('<div class="alert alert-danger">' + t + " | " + e + ": " + a + "</div>")) : $("aside").append('<div class="sidebar error"> <h2>Error Report</h2> <div class="alert alert-danger">' + t + " | " + e + ": " + a + "</div> </div>"), setTimeout(() => {
